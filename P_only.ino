...
#define _DUTY_NEU 1250 // 1500
#define _DUTY_MIN 660 // 1000

#define _SERVO_ANGLE_DIFF  113   // Replace with |D - E| degree
#define _SERVO_SPEED       600   // servo speed 

// Target Distance
#define _DIST_TARGET    160 // Center of the rail (unit: mm)

// PID parameters
#define _KP  4.4    // proportional gain
...
void loop()
{
  ...
  if (event_dist) {
    ...
    error_current = (_DIST_TARGET - dist_ema); // (_DIST_TARGET - dist_ema)
...
float volt_to_distance(int a_value)
{
  ...
  return 1493 * exp(-7.47E-3 * a_value);
}
